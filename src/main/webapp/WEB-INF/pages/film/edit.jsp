...
<div>
    ...
    <div class="container">
        <form:form action="${pageContext.request.contextPath}/film/${film.id}/save" method="post" modelAttribute="film">

            <div class="form-group">
                <label for="id">ID:</label>
                <div><form:input type="text" class="form-control" id="id" path="id" value="${film.id}" readonly="true"/></div>
            </div>
            
            <div class="form-group">
                <label for="naziv"><fmt:message key="film.naziv"/>:</label>
                <div><form:input type="text" class="form-control" id="naziv" path="naziv" value="${film.naziv}" maxlength="100"/></div>
            ...
            <div class="form-group">    
                ...
                <div><form:input type="number" class="form-control" id="trajanje" path="trajanje" value="${film.trajanje}" max="9999"/></div>
                <div class="text-danger">
            ...
            <div class="form-group">    
                ...
                <div><form:input type="number" class="form-control" id="godina" path="godina" value="${film.godina}" max="999999"/></div>
                <div class="text-danger">
            ...
            <div class="form-group">    
                ...
                <div><form:input type="text" class="form-control" id="url" path="url" value="${film.url}" maxlength="200"/></div>
                <div class="text-danger">
            ...
            <div class="form-group">    
                <label for="opis"><fmt:message key="film.opis" />:</label>
                <div><form:textarea type="text" class="form-control" id="opis" path="opis" value="${film.opis}"/></div>
                <div class="text-danger">
            ...
            <div class="custom-control custom-checkbox">
                <form:checkbox path="aktivan" class="custom-control-input" id="aktivan" value="${film.aktivan}" />
